            ...
            <section>   
                <div class="row py-5 px-3">
                    ...
                    <div class="image-container">
                        <img src="{{ asset('images/img1.png') }}" alt="" class="thumbnail" onclick="openModal()">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="quantity-container  mx-5 py-3">
                         ...
                         <div class="row px-5 py-3">
                          ...
                          <p><strong>Categories</strong><a class="A" href="https://abonnement-iptvpremium.com/?product_cat=abonnement-iptv">   Abonnement IPTV</a>, <a class="A" href="https://abonnement-iptvpremium.com/?product_cat=abonnement-iptv">IPTV</a>,<a class="A" href="https://abonnement-iptvpremium.com/?product_cat=iptv-premium"> IPTV Premium</a></p>
                        </div>
                    </div>
                </div>          
            </section>
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="row g-0"> 
                                ...
                                <div class="col-md-3 text-center">
                                  <a href="{{ route('Renouvelement') }}"><img src="{{ ('images/img3.png') }}" class="img-fluid fill-image"></a>
                                    <p class="image-description">
